...
void UIData::UIDataInit() {
  ...
  //            (f32)super_cap_data.super_cap_voltage * 1000.0f);
  // Float_Draw(&ammo_speed_jugde, "asj", UI_Graph_ADD, 2, UI_Color_White, 25, 2, 2, 360, 850,
  //            (f32)can_communicate->gimbal_data_feedback_.aim_speed_change * 1000.0f);
  // Float_Draw(&remain_bullet, "rbn", UI_Graph_ADD, 2, UI_Color_White, 25, 2, 2, 1362, 475,
  //            (f32)referee_data.remain_bullet_number * 1000.0f);
...
void UIData::UIDataUpdate() {
  // 电容电压
  // if (chassis_mode_data.chassis_speed_mode == HIGH_SPEED) {
  ...
  // }
  // // 弹速调节
  // if (can_communicate->gimbal_data_feedback_.aim_speed_change > 0) {
  //   Float_Draw(&ammo_speed_jugde, "asj", UI_Graph_Change, 2, UI_Color_Green, 25, 2, 2, 360, 850,
  //              (f32)can_communicate->gimbal_data_feedback_.aim_speed_change * 1000.0f);
  // } else if (can_communicate->gimbal_data_feedback_.aim_speed_change < 0) {
  ...
  // }
  // // 剩余子弹
  // if (referee_data.remain_bullet_number < 0) {
  //   Float_Draw(&remain_bullet, "rbn", UI_Graph_Change, 2, UI_Color_Pink, 25, 2, 2, 1362, 475,
  //              (f32)referee_data.remain_bullet_number * 1000.0f);
  // } else if (referee_data.remain_bullet_number < 100) {
  ...
  // }
  // // // 自瞄模式
  // if (can_communicate->gimbal_data_feedback_.get_target_flag == 1) {
  ...
  // if (can_communicate->gimbal_data_feedback_.suggest_fire_flag == 1) {
...
void RefereeTask(void const *argument) {
  ...
  while (1) {
    ...
    // if (can_communicate->gimbal_data_feedback_.UI_show_flag == 1) {
    //   UI_data->UIDataInit();
    //   UI_data->UIDataSend();
    // } else {
